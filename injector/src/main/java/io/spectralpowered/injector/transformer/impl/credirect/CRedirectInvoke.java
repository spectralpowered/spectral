        ...
        for (AbstractInsnNode instruction : targetNodes) {
            ...
            boolean cast;
            {
                ...
                if (methodInsnNode.getOpcode() == Opcodes.INVOKESTATIC) {
                    ...
                    if (!ASMUtils.compareTypes(originalArgumentTypes, argumentTypes, true, Types.type(methodInsnNode.owner))) {
                        throw new TransformerException(transformerMethod, transformer, "does not have same argument types as original invoke with instance")
                                .help(Codifier.of(transformerMethod).param(null).params(Types.type(methodInsnNode.owner)).params(originalArgumentTypes));
                    }
                }
            }
