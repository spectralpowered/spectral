...
import kyle.annotations.CTransformer;
import kyle.mappings.AMapper;
import kyle.mappings.impl.VoidMapper;
import kyle.targets.IInjectionTarget;
import kyle.targets.impl.*;
import kyle.transformer.*;
import kyle.transformer.impl.*;
import kyle.utils.ASMUtils;
import kyle.utils.HotswapClassLoader;
import kyle.utils.log.DefaultLogger;
import kyle.utils.log.ILogger;
...
public class TransformerManager implements ClassFileTransformer {
    ...
    /**
     * Add a new injection target for use with the {@link kyle.annotations.CTarget} annotation
     *
