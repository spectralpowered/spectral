...
public class class423 extends class195 {
	...
	static class99 field3456;
	@ObfInfo(
		owner = "gz",
		name = "q",
		desc = "Ljv;"
	)
	static class99 field3459;
	@ObfInfo(
		owner = "gz",
		name = "m",
		desc = "I"
	...
	static {
		field3459 = new class99(64);
		field3456 = new class99(50);
	}
	...
	@ObfInfo(
		owner = "gz",
		name = "q",
		desc = "(Lga;ILga;ILgp;B)Lhh;"
	)
	public final class470 method2066(class242 var1, int var2, class242 var3, int var4, class207 var5) {
		if (null != this.field3493) {
			class423 var7 = this.method2054();
			return var7 == null ? null : var7.method2066(var1, var2, var3, var4, var5);
		} else {
			long var11 = (long)this.field3461;
			if (var5 != null) {
				var11 |= var5.field1787 << 16;
			}

			class470 var9 = (class470)field3456.method394(var11);
			if (null == var9) {
				...
				field3456.method396(var9, var11);
			}

			class470 var13;
			if (var1 != null && null != var3) {
				var13 = var1.method1062(var9, var2, var3, var4);
			} else if (var1 != null) {
				var13 = var1.method1053(var9, var2);
			} else if (null != var3) {
				var13 = var3.method1053(var9, var4);
			} else {
				var13 = var9.method2298(true);
			}

			if (this.field3495 != 128 || this.field3466 != 128) {
				var13.method2320(this.field3495, this.field3466, this.field3495);
			}
	...
	@ObfInfo(
		owner = "gz",
		name = "g",
		desc = "(ILjava/lang/String;B)Ljava/lang/String;"
	)
	...
	static int method2067(int var0, class461 var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.APPEND_NUM) {
			...
			if (var0 == ScriptOpcodes.APPEND) {
				...
				var4 = class386.field3249[class386.field3250];
				var10 = class386.field3249[1 + class386.field3250];
				class386.field3249[++class386.field3250 - 1] = var4 + var10;
				return 1;
			} else if (var0 == ScriptOpcodes.APPEND_SIGNNUM) {
				var4 = class386.field3249[--class386.field3250];
				var5 = class386.field3248[--class161.field1227];
				class386.field3249[++class386.field3250 - 1] = var4 + class364.method1810(var5, true);
				return 1;
				...
				if (var0 == ScriptOpcodes.FROMDATE) {
					...
					class386.field3245.setTime(new Date(var12));
					...
					return 1;
				} else if (var0 != ScriptOpcodes.TEXT_BODYTYPE) {
					if (var0 == ScriptOpcodes.TOSTRING) {
						var11 = class386.field3248[--class161.field1227];
						class386.field3249[++class386.field3250 - 1] = Integer.toString(var11);
						return 1;
						...
						if (var0 == ScriptOpcodes.PARAHEIGHT) {
							...
							var14 = class471.field3963.method1365(var6, 0);
							var15 = new class58(var14);
							class386.field3248[++class161.field1227 - 1] = var15.method2024(var4, var5);
							return 1;
							...
							var14 = class471.field3963.method1365(var6, 0);
							var15 = new class58(var14);
							class386.field3248[++class161.field1227 - 1] = var15.method2023(var4, var5);
							return 1;
							...
							if (class386.field3248[--class161.field1227] == 1) {
								...
								class386.field3249[++class386.field3250 - 1] = var10;
							}
							...
							var4 = class386.field3249[--class386.field3250];
							var5 = class386.field3248[--class161.field1227];
							class386.field3249[++class386.field3250 - 1] = var4 + (char)var5;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISPRINTABLE) {
							var11 = class386.field3248[--class161.field1227];
							class386.field3248[++class161.field1227 - 1] = class343.method1744((char)var11) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHANUMERIC) {
							var11 = class386.field3248[--class161.field1227];
							class386.field3248[++class161.field1227 - 1] = class87.method374((char)var11) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISALPHA) {
							var11 = class386.field3248[--class161.field1227];
							class386.field3248[++class161.field1227 - 1] = class105.method418((char)var11) ? 1 : 0;
							return 1;
						} else if (var0 == ScriptOpcodes.CHAR_ISNUMERIC) {
							var11 = class386.field3248[--class161.field1227];
							class386.field3248[++class161.field1227 - 1] = class221.method980((char)var11) ? 1 : 0;
							return 1;
							...
							var5 = class386.field3248[class161.field1227];
							var6 = class386.field3248[1 + class161.field1227];
							class386.field3249[++class386.field3250 - 1] = var4.substring(var5, var6);
							return 1;
							...
							class386.field3249[++class386.field3250 - 1] = var19.toString();
							return 1;
						} else if (var0 == ScriptOpcodes.STRING_INDEXOF_CHAR) {
							var4 = class386.field3249[--class386.field3250];
							var5 = class386.field3248[--class161.field1227];
							class386.field3248[++class161.field1227 - 1] = var4.indexOf(var5);
							return 1;
							...
							class386.field3248[++class161.field1227 - 1] = var4.indexOf(var10, var6);
							return 1;
							...
							var4 = class386.field3249[class386.field3250];
							var10 = class386.field3249[1 + class386.field3250];
							String var16 = class386.field3249[2 + class386.field3250];
