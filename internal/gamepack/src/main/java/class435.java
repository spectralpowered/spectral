		...
		try {
			...
			if (-1L != this.field3601) {
				...
				if (var14 > -1L && var11 > var14) {
					...
					System.arraycopy(this.field3605, (int)(var14 - this.field3601), var1, (int)(var14 - var5) + var2, var13);
		...
		try {
			...
			if (var3 <= this.field3605.length) {
				...
				if (var10 > -1L && var7 > var10) {
					...
					System.arraycopy(var1, (int)(var10 + (long)var2 - this.field3608), this.field3607, (int)(var10 - this.field3604), var9);
				}
