				...
				if (0 != var2.field3410[var4]) {
					...
					try {
						...
						if (var5 == 0) {
							...
							var6 = var2.field3411[var4];
							Reflection.setInt(var6, (Object)null, var2.field3408[var4]);
							var0.method544(0);
						} else if (var5 == 2) {
							var6 = var2.field3411[var4];
						...
						if (var5 != 3) {
							...
							var26 = var2.field3414[var4];
							byte[][] var11 = var2.field3407[var4];
							...
							if (var12 == null) {
								...
								var0.method544(1);
								var0.method536(((Number)var12).longValue());
							} else if (var12 instanceof String) {
								var0.method544(2);
								var0.method538((String)var12, (byte)117);
							} else {
								var0.method544(4);
							}
						}
