...
public class class184 {
	...
	static final BigInteger field1683;
	@ObfInfo(
		owner = "ba",
		name = "m",
		desc = "Ljava/math/BigInteger;"
	)
	static final BigInteger field1684;

	static {
		field1684 = new BigInteger("80782894952180643741752986186714059433953886149239752893425047584684715842049");
		field1683 = new BigInteger("7237300117305667488707183861728052766358166655052137727439795191253340127955075499635575104901523446809299097934591732635674173519120047404024393881551683");
	}
