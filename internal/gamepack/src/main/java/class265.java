...
public class class265 implements class78 {
   ...
   static final void method1220(class6 var0, int var1, class380 var2, int var3) {
      ...
      if ((var3 & 4096) != 0) {
         ...
         var2.field2657 = (var6 & '\uffff') + client.field231;
         var2.field2655 = 0;
         var2.field2644 = 0;
      ...
      if (0 != (var3 & 2)) {
         var6 = var0.method575();
         class425 var15 = (class425)class2.method10(class283.method1394(), var0.method592());
         boolean var16 = var0.method592() == 1;
         var9 = var0.method569();
         var10 = var0.field1070;
         if (var2.field3207 != null && null != var2.field3194) {
            boolean var11 = false;
            if (var15.field3523 && class240.field2021.method41(var2.field3207)) {
               var11 = true;
            }
            ...
            if (!var11 && client.field404 == 0 && !var2.field3213) {
               ...
               var2.field2678 = 150;
               var2.field2629 = var16;
               var2.field2617 = class113.field846 != var2 && var15.field3523 && client.field457 != "" && var12.toLowerCase().indexOf(client.field457) == -1;
               if (var15.field3509) {
                  var13 = var16 ? 91 : 1;
               } else {
                  var13 = var16 ? 90 : 2;
               ...
               if (-1 != var15.field3521) {
                  class164.method765(var13, class185.method843(var15.field3521) + var2.field3207.method1101(), var12);
               } else {
      ...
      if ((var3 & 1) != 0) {
         ...
         if (var6 > 0) {
            for(var7 = 0; var7 < var6; ++var7) {
               ...
               var23 = var0.method559();
               var2.method1676(var17, var10, var9, var22, client.field231, var23);
            }
         }
         ...
         if (var7 > 0) {
            for(var17 = 0; var17 < var7; ++var17) {
               ...
               if (var10 != 32767) {
                  var22 = var0.method559();
                  var23 = var0.method569();
                  var13 = var10 > 0 ? var0.method547() : var23;
                  var2.method1679(var9, client.field231, var10, var22, var23, var13);
               } else {
      ...
      if (var2.field3205) {
         if (var5 == 127) {
            ...
            if (var5 != class294.field2385.field2389) {
               ...
               var20 = (class294)class2.method10(var18, var5);
            } else {
               var20 = class268.field2225[var1];
            }

            var2.method1878(var2.field3219, var2.field3221, var20);
         }
      }
