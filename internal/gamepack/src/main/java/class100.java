...
public class class100 {
	...
	static final class385 field795;
	@ObfInfo(
		owner = "da",
		name = "v",
		desc = "Lmm;"
	)
	static final class477 field793;
	@ObfInfo(
		owner = "da",
		name = "h",
		desc = "Ljava/util/Map;"
	)
	static final Map field792;

	static {
		field792 = new HashMap();
		field795 = new class385(1024);
		field793 = new class477();
		field794 = 0;
	}
	...
	static final void method397(class127 var0, int var1, int var2, int var3, int var4, int var5, int var6) {
		...
		if (var8) {
			...
			while (true) {
				...
				if (var9 == 0) {
					if (var1 == 0) {
						int[] var10 = class71.field636[0][var2];
						int var13 = var4 + 932731;
						int var14 = var5 + 556238;
						int var15 = class2.method11(var13 + 45365, var14 + 91923, 4) - 128 + (class2.method11(var13 + 10294, var14 + 37821, 2) - 128 >> 1) + (class2.method11(var13, var14, 1) - 128 >> 2);
				...
				if (var9 == 1) {
					int var16 = var0.method547();
					if (var16 == 1) {
						var16 = 0;
					}

					if (var1 == 0) {
						class71.field636[0][var2][var3] = 8 * -var16;
					} else {
						class71.field636[var1][var2][var3] = class71.field636[var1 - 1][var2][var3] - var16 * 8;
					}
					break;
				}
