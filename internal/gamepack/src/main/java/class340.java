	...
	static final void method1707(class334 var0, int var1) {
		...
		if (var0.field2663 >= client.field231) {
			...
			if (var0.field2664 >= client.field231) {
				boolean var12 = client.field231 == var0.field2664 || var0.field2649 == -1 || var0.field2652 != 0;
				if (!var12) {
					var4 = class271.method1277(var0.field2649);
					if (null != var4 && !var4.method1056()) {
						var12 = 1 + var0.field2651 > var4.field2037[var0.field2640];
					} else {
						var12 = true;
					}
				}
				...
				if (var0.field2607 == 0) {
					...
					label496: {
						if (-1 != var0.field2649 && var0.field2652 == 0) {
							var3 = class271.method1277(var0.field2649);
							if (var0.field2682 > 0 && 0 == var3.field2039) {
								++var0.field2669;
								break label496;
							}

							if (var0.field2682 <= 0 && var3.field2034 == 0) {
								++var0.field2669;
								break label496;
							}
						}

						var15 = var0.field2672;
						...
						class294 var14 = var0.field2661[var0.field2607 - 1];
						if (var5 - var15 <= 256 && var5 - var15 >= -256 && var6 - var13 <= 256 && var6 - var13 >= -256) {
							...
							if (class294.field2388 == var14) {
								var10 <<= 1;
							} else if (class294.field2387 == var14) {
								var10 >>= 1;
							}
		...
		if (var0.field2645 != -1) {
			var3 = class271.method1277(var0.field2645);
			if (var3 != null) {
				if (!var3.method1056() && null != var3.field2043) {
					++var0.field2647;
					if (var0.field2646 < var3.field2043.length && var0.field2647 > var3.field2037[var0.field2646]) {
						var0.field2647 = 1;
						++var0.field2646;
						class17.method84(var3, var0.field2646, var0.field2672, var0.field2608);
					}

					if (var0.field2646 >= var3.field2043.length) {
						if (var3.field2046 > 0) {
							var0.field2646 -= var3.field2046;
							if (var3.field2047) {
								++var0.field2648;
							}

							if (var0.field2646 < 0 || var0.field2646 >= var3.field2043.length || var3.field2047 && var0.field2648 >= var3.field2050) {
								var0.field2647 = 0;
								var0.field2646 = 0;
								var0.field2648 = 0;
							}
				...
				} else if (var3.method1056()) {
					++var0.field2646;
					var13 = var3.method1058();
					if (var0.field2646 < var13) {
						class91.method383(var3, var0.field2646, var0.field2672, var0.field2608);
					} else {
						if (var3.field2046 > 0) {
							var0.field2646 -= var3.field2046;
							if (var3.field2047) {
							...
							if (var0.field2646 < 0 || var0.field2646 >= var13 || var3.field2047 && var0.field2648 >= var3.field2050) {
								var0.field2646 = 0;
								var0.field2647 = 0;
								var0.field2648 = 0;
							}
		...
		if (-1 != var0.field2654 && client.field231 >= var0.field2657) {
			...
			var15 = class429.method2119(var0.field2654).field2585;
			if (var15 != -1) {
				var4 = class271.method1277(var15);
		...
		if (var0.field2649 != -1 && var0.field2652 <= 1) {
			var3 = class271.method1277(var0.field2649);
			if (1 == var3.field2039 && var0.field2682 > 0 && var0.field2663 <= client.field231 && var0.field2664 < client.field231) {
				var0.field2652 = 1;
				return;
			}
		}
		...
		if (-1 != var0.field2649 && 0 == var0.field2652) {
			...
			if (null == var3) {
				var0.field2649 = -1;
			} else if (!var3.method1056() && null != var3.field2043) {
				++var0.field2651;
				if (var0.field2640 < var3.field2043.length && var0.field2651 > var3.field2037[var0.field2640]) {
					var0.field2651 = 1;
					++var0.field2640;
					class17.method84(var3, var0.field2640, var0.field2672, var0.field2608);
				}

				if (var0.field2640 >= var3.field2043.length) {
					var0.field2640 -= var3.field2046;
					++var0.field2653;
					if (var0.field2653 >= var3.field2050) {
						var0.field2649 = -1;
					} else if (var0.field2640 >= 0 && var0.field2640 < var3.field2043.length) {
						class17.method84(var3, var0.field2640, var0.field2672, var0.field2608);
					} else {
						var0.field2649 = -1;
					}
				...
				var0.field2609 = var3.field2031;
			} else if (var3.method1056()) {
				++var0.field2640;
				var13 = var3.method1058();
				if (var0.field2640 < var13) {
					class91.method383(var3, var0.field2640, var0.field2672, var0.field2608);
				} else {
					var0.field2640 -= var3.field2046;
					++var0.field2653;
					if (var0.field2653 >= var3.field2050) {
