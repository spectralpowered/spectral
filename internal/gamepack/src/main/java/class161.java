...
public class class161 implements class78 {
	...
	static final class161 field1221;
	@ObfInfo(
		owner = "cp",
		name = "x",
		desc = "Lcp;"
	)
	static final class161 field1222;
	@ObfInfo(
		owner = "cp",
		name = "m",
		desc = "Lcp;"
	)
	static final class161 field1223;
	@ObfInfo(
		owner = "cp",
		name = "h",
		desc = "Lcp;"
	)
	static final class161 field1224;
	@ObfInfo(
		owner = "cp",
		name = "q",
		desc = "Lcp;"
	)
	static final class161 field1228;
	@ObfInfo(
		owner = "cp",
		name = "v",
		desc = "Lcp;"
	)
	static final class161 field1230;
	@ObfInfo(
		owner = "cp",
		name = "f",
		desc = "I"
	...
	static {
		field1224 = new class161(0, -1);
		field1221 = new class161(1, 2);
		field1230 = new class161(2, 3);
		field1222 = new class161(3, 4);
		field1223 = new class161(4, 5);
		field1228 = new class161(5, 6);
	}
