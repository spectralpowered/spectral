...
public class class73 {
	...
	public class73(class274 var1, class274 var2) {
		this.field657 = new class170(256);
		this.field656 = new class170(256);
		this.field655 = var1;
		this.field654 = var2;
	}
	...
	static int method321(int var0, class461 var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.ENUM_STRING) {
			...
			class236 var6 = class161.method738(var4);
			if (var6.field1998 != 's') {
			}

			for (var7 = 0; var7 < var6.field2001; ++var7) {
				if (var5 == var6.field1996[var7]) {
					class386.field3249[++class386.field3250 - 1] = var6.field2003[var7];
					var6 = null;
					break;
				}
			}
			...
			if (null != var6) {
				class386.field3249[++class386.field3250 - 1] = var6.field1999;
			}
			...
			if (var0 == ScriptOpcodes.ENUM_GETOUTPUTCOUNT) {
				...
				class386.field3248[++class161.field1227 - 1] = var11.method1028();
				return 1;
			} else {
				return 2;
			}
			...
			var4 = class386.field3248[class161.field1227];
			var5 = class386.field3248[1 + class161.field1227];
			int var10 = class386.field3248[2 + class161.field1227];
			var7 = class386.field3248[3 + class161.field1227];
			class236 var8 = class161.method738(var10);
