...
public class class231 {
	...
	class231() {
		this.field1951 = new int[]{0, 0, 0, 0, 0};
		this.field1952 = new int[]{0, 0, 0, 0, 0};
		this.field1953 = new int[]{0, 0, 0, 0, 0};
		this.field1955 = 0;
		this.field1967 = 100;
		this.field1958 = 500;
		this.field1959 = 0;
		...
		if (var2 < 10) {
			...
			for (var11 = 0; var11 < var1; ++var11) {
				...
				if (this.field1948 != null) {
					...
					var13 = var13 * ((this.method1000(var10, var15, this.field1948.field4064) >> 1) + 32768) >> 15;
				...
				for (var14 = 0; var14 < 5; ++var14) {
					if (this.field1951[var14] != 0) {
						...
						if (var15 < var1) {
							var10000 = field1954;
							var10000[var15] += this.method1000(field1964[var14], var13 * field1944[var14] >> 15, this.field1961.field4064);
							var10000 = field1964;
							var10000[var14] += (var12 * field1966[var14] >> 16) + field1968[var14];
						}
					}
				}
			}
			...
			if (this.field1955 > 0 && this.field1967 > 0) {
				...
				for (var12 = var11; var12 < var1; ++var12) {
					var10000 = field1954;
					var10000[var12] += field1954[var12 - var11] * this.field1967 / 100;
				}
			}
