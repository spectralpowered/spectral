...
public class class262 {
	...
	class262() {
		this.field2122 = new class321();
		this.field2117 = new class321();
		...
		this.field2118 = Integer.MAX_VALUE;
		this.field2120 = Integer.MAX_VALUE;
		this.field2134 = 0;
		this.field2133 = 0;
		this.field2119 = 0;
		this.field2116 = 0;
	...
	public void method1135() {
		if (!this.method1137() && this.field2123 > 0) {
			...
			int var3 = this.field2122.method1623((Integer)var2.field2392, this.field2123);
			this.method1176();
	...
	public void method1136() {
		if (!this.method1137() && this.field2123 < this.field2122.method1620()) {
			...
			int var3 = this.field2122.method1623(this.field2123, (Integer)var2.field2391);
			this.method1176();
			this.method1139(var3, var3);
		}
	...
	public void method1195(boolean var1) {
		...
		this.method1192((Integer)var3.field2392, var1);
	}
	...
	public void method1140(boolean var1) {
		class296 var3 = this.method1185(this.field2123);
		this.method1192((Integer)var3.field2391, var1);
	}
	...
	public void method1149(boolean var1) {
		...
		this.method1192(this.field2122.method1630((Integer)var4.field2392, this.field2116), var1);
	}
	...
	public void method1150(boolean var1) {
		class239 var3 = this.field2122.method1641(0, this.field2123);
		class296 var4 = var3.method1037();
		this.method1192(this.field2122.method1630((Integer)var4.field2392, this.field2133 + this.field2116), var1);
	}
	...
	public void method1151(int var1, int var2, boolean var3, boolean var4) {
		...
		if (var3 && var4) {
			...
			this.field2127 = 1;
			var7 = this.method1173(var9);
			this.method1139((Integer)var7.field2392, (Integer)var7.field2391);
			this.field2131 = (Integer)var7.field2392;
		} else if (var4) {
	...
	void method1188(class296 var1, class296 var2) {
		if ((Integer)var2.field2392 < (Integer)var1.field2392) {
			this.method1139((Integer)var1.field2391, (Integer)var2.field2392);
		} else {
			this.method1139((Integer)var1.field2392, (Integer)var2.field2391);
		}
	...
	void method1175() {
		...
		int var5 = (Integer)var3.field2392 - 10;
		int var6 = var5 + 20;
		int var7 = (Integer)var3.field2391 - 3;
