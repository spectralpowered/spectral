...
public abstract class class214 extends Applet implements Runnable, FocusListener, WindowListener {
	...
	static class214 field1845;
	@ObfInfo(
		owner = "an",
		name = "aj",
		desc = "Las;"
	)
	static class433 field1861;
	@ObfInfo(
		owner = "an",
		name = "v",
		desc = "I"
	...
	static long field1853;
	@ObfInfo(
		owner = "an",
		name = "ap",
		desc = "J"
	)
	static long field1871;
	@ObfInfo(
		owner = "an",
		name = "aa",
		desc = "J"
	)
	static long field1873;
	@ObfInfo(
		owner = "an",
		name = "k",
		desc = "[J"
	)
	static long[] field1855;
	@ObfInfo(
		owner = "an",
		name = "o",
		desc = "[J"
	)
	static long[] field1857;
	@ObfInfo(
		owner = "an",
		name = "ah",
		desc = "Z"
	)
	static volatile boolean field1870;
	@ObfInfo(
		owner = "an",
		name = "ab",
		desc = "Z"
	...
	volatile boolean field1862;
	@ObfInfo(
		owner = "an",
		name = "al",
		desc = "Z"
	)
	volatile boolean field1865;
	@ObfInfo(
		owner = "an",
		name = "ag",
		desc = "J"
	)
	volatile long field1866;
	...
	static {
		...
		field1848 = 1;
		field1849 = 0;
		field1857 = new long[32];
		field1855 = new long[32];
		field1863 = 500;
		field1870 = true;
		field1861 = new class433();
		field1871 = -1L;
		field1873 = -1L;
	}
		...
		if (!var1) {
			...
			if (!var1) {
				...
				if (class309.field2461.method945()) {
					var19 = class480.method2370(class356.field3013, client.field279.field4042);
					var19.field2403.method534(1057001181);
					client.field279.method2389(var19);
				}
				...
				client.method189();
				class255.method1094();
				var19 = class480.method2370(class356.field2990, client.field279.field4042);
				client.field279.method2389(var19);
				class74.method325();
			}
		}
