	...
	boolean method1355(int var1, int[] var2) {
		if (null == this.field2303[var1]) {
			...
			if (var7) {
				...
				byte[] var26 = class430.method2120(var22);
				if (this.field2307) {
				...
				if (var4 > 1) {
					...
					var10 -= var11 * var4 * 4;
					class127 var12 = new class127(var26);
					...
					if (var26 == null) {
						...
						class47 var28 = new class47();
						var28.method261(var26);
						var27 = var28;
					} else {
						var27 = var26;
					}
