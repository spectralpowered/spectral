...
public class class212 implements class78 {
	...
	static final class212 field1835;
	@ObfInfo(
		owner = "im",
		name = "e",
		desc = "Lim;"
	)
	static final class212 field1836;
	@ObfInfo(
		owner = "im",
		name = "h",
		desc = "Lim;"
	)
	static final class212 field1837;
	@ObfInfo(
		owner = "im",
		name = "x",
		desc = "Lim;"
	)
	static final class212 field1840;
	@ObfInfo(
		owner = "im",
		name = "q",
		desc = "B"
	...
	static {
		field1837 = new class212(2, (byte)0);
		field1836 = new class212(3, (byte)1);
		field1835 = new class212(0, (byte)2);
		field1840 = new class212(1, (byte)3);
	}
