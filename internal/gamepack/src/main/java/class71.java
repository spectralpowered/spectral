...
public final class class71 {
	...
	static final int[] field635;
	@ObfInfo(
		owner = "cf",
		name = "p",
		desc = "[I"
	)
	static final int[] field639;
	@ObfInfo(
		owner = "cf",
		name = "l",
		desc = "[I"
	)
	static final int[] field642;
	@ObfInfo(
		owner = "cf",
		name = "c",
		desc = "[I"
	)
	static final int[] field645;
	@ObfInfo(
		owner = "cf",
		name = "t",
		desc = "[I"
	)
	static final int[] field646;
	@ObfInfo(
		owner = "cf",
		name = "d",
		desc = "[I"
	...
	static {
		field636 = new int[4][105][105];
		field644 = new byte[4][104][104];
		field637 = 99;
		field642 = new int[]{1, 2, 4, 8};
		field646 = new int[]{16, 32, 64, 128};
		field645 = new int[]{1, 0, -1, 0};
		field639 = new int[]{0, -1, 0, 1};
		field647 = new int[]{1, -1, -1, 1};
		field635 = new int[]{-1, -1, 1, 1};
		field649 = (int)(Math.random() * 17.0D) - 8;
		field650 = (int)(Math.random() * 33.0D) - 16;
	}
	...
	static void method311() {
		...
		if (client.field248 == 0) {
			...
			for (var1 = 0; var1 < 4; ++var1) {
				client.field289[var1] = new class427(104, 104);
			}
			...
			byte var24 = 0;
			var1 = var24 + class431.field3575.method151() * 4 / 100;
			var1 += class374.field3179.method151() * 4 / 100;
			var1 += class473.field3989.method151() * 2 / 100;
			var1 += class313.field2473.method151() * 2 / 100;
			var1 += class303.field2437.method151() * 6 / 100;
			var1 += class440.field3648.method151() * 4 / 100;
			var1 += class317.field2494.method151() * 2 / 100;
			var1 += class16.field82.method151() * 55 / 100;
			var1 += class446.field3678.method151() * 2 / 100;
			var1 += class298.field2397.method151() * 2 / 100;
			var1 += class49.field570.method151() * 2 / 100;
			var1 += class32.field176.method151() * 2 / 100;
			var1 += class329.field2596.method151() * 2 / 100;
			var1 += class471.field3963.method151() * 2 / 100;
			var1 += class85.field702.method151() * 2 / 100;
			var1 += class306.field2456.method151() * 2 / 100;
			var1 += class460.field3809.method151() / 100;
			var1 += class96.field782.method151() / 100;
			var1 += class46.field549.method151() / 100;
			var1 += class187.field1697.method151() / 100;
			var1 += class1.field7.method150() && class1.field7.method1345() ? 1 : 0;
			if (var1 != 100) {
				if (var1 != 0) {
					class359.field3057 = class177.field1340 + var1 + "%";
				}
			...
			boolean var23 = !client.field274;
			class233.field1985 = 22050;
			class40.field207 = var23;
			class189.field1707 = 2;
			class491 var20 = new class491();
			var20.method2407(9, 128);
			class402.field3388 = class241.method1044(class21.field104, 0, 22050);
			class402.field3388.method1006(var20);
			class387.method1902(class306.field2456, class85.field702, class303.field2437, var20);
			...
			var1 = class460.method2268().length;
			client.field283 = class238.field2014.method818(class460.method2268());
			if (client.field283.size() < var1) {
				class359.field3057 = class177.field1520 + client.field283.size() * 100 / var1 + "%";
			...
			if (60 == client.field248) {
				var1 = class416.method2016(class49.field570, class446.field3678);
				var3 = class446.field3678;
				var4 = class359.field3063.length + class359.field3065.length;
				String[] var21 = class359.field3083;

				for (int var6 = 0; var6 < var21.length; ++var6) {
					String var22 = var21[var6];
					if (var3.method1356(var22) != -1) {
						++var4;
					}
				}

				if (var1 < var4) {
					class359.field3057 = class177.field1345 + var1 * 100 / var4 + "%";
				...
				if (!class473.field3989.method1345()) {
					...
					class38 var25 = class473.field3989;
					class179.field1646 = var25;
					class261.method1112(class473.field3989);
					class38 var2 = class473.field3989;
					var3 = class16.field82;
					class164.field1239 = var2;
					class164.field1247 = var3;
					...
					class38 var16 = class473.field3989;
					class50.field575 = var16;
					...
					class38 var5 = class473.field3989;
					class85.field699 = var5;
					...
					class38 var17 = class473.field3989;
					class198.field1743 = var17;
				...
				if (var1 < 11) {
					class359.field3057 = class177.field1444 + var1 * 100 / 12 + "%";
					...
					class128.field1075[0].method1747(var14 + var19, var18 + var19, var19 + var4);
				...
				var1 = class176.field1322.method1084();
				if (var1 < 100) {
					class359.field3057 = class177.field1351 + var1 + "%";
					class359.field3056 = 90;
				} else {
				...
				if (!class49.field570.method1358("huffman", "")) {
					...
					class364 var15 = new class364(class49.field570.method1357("huffman", ""));
					class386.method1899(var15);
