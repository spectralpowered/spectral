...
public final class class181 {
   ...
   public void method829(class274 var1, String var2, boolean var3) {
      if (!this.field1673) {
         ...
         int var9 = this.field1663.method230() - this.field1663.method236() + 1;
         int var10 = this.field1663.method232() - this.field1663.method231() + 1;
         System.nanoTime();
         System.nanoTime();
         class144.field1152.method440();
         this.field1666 = new class144[var9][var10];
         ...
         for(int var18 = 0; var18 < var9; ++var18) {
            for(int var20 = 0; var20 < var10; ++var20) {
               if (this.field1666[var18][var20] == null) {
                  this.field1666[var18][var20] = new class144(this.field1663.method236() + var18, this.field1663.method231() + var20, this.field1663.method234(), this.field1671);
                  this.field1666[var18][var20].method685(this.field1663.field1750, this.field1663.field1751);
               }
            }
         }
         ...
         if (var1.method1362(class430.field3572.field3571, var2)) {
            byte[] var19 = var1.method1357(class430.field3572.field3571, var2);
            this.field1664 = class476.method2357(var19);
         }
