...
public class class397 {
	...
	void method1952() {
		...
		for (var2 = 0; var2 < 64; ++var2) {
			this.field3339[var2 + 64] = var2 * 4 + 65280;
		}

		for (var2 = 0; var2 < 64; ++var2) {
			this.field3339[var2 + 128] = 65535 + var2 * 262144;
		}
		...
		this.field3335 = 0;
		this.field3345 = new int[32768];
		this.field3346 = new int[32768];
		this.method1957((class344)null);
		this.field3343 = new int[32768];
		this.field3347 = new int[32768];
	}
		...
		for (int var4 = 1; var4 < 255; ++var4) {
			...
			for (int var10 = var7; var10 < var8; ++var10) {
				...
				if (var11 != 0 && var12 >= class162.field1236 && var12 < class162.field1237) {
					...
					class39.field199.field578[var9++] = -16777216 | ((var11 & 16711935) * var13 + (var15 & 16711935) * var14 & -16711936) + ((var15 & 65280) * var14 + var13 * (var11 & 65280) & 16711680) >> 8;
				} else {
					++var9;
				}
			}
