		...
		for (int var2 = 0; var2 < client.field277; ++var2) {
			...
			if (0 != (var5 & 512)) {
				...
				if (1 == (var6 & 1)) {
					...
					var4.method1266(new class207(var17, var14, var15, var16));
				}
			}
			...
			if (0 != (var5 & 8)) {
				...
				var9 = var4.field2608 - 64 * (var7 - class325.field2575 - class325.field2575);
				if (var8 != 0 || var9 != 0) {
			...
			if (0 != (var5 & 16384)) {
				...
				if (1 == (var6 & 1)) {
					...
					var4.method1264(new class207(var17, var14, var15, var16));
				}
			}
			...
			if (0 != (var5 & 2)) {
				...
				var4.field2657 = (var6 & 65535) + client.field231;
				var4.field2655 = 0;
				var4.field2644 = 0;
