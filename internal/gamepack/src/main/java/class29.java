	...
	boolean method133(double var1, int var3, class274 var4) {
		...
		for (int var6 = 0; var6 < this.field166.length; ++var6) {
			...
			for (var13 = 0; var13 < var18.length; ++var13) {
				var18[var13] = class341.method1714(var18[var13], var1);
			}
			...
			if (var13 == 0) {
				if (var7.field2758 == var3) {
					for (var14 = 0; var14 < var5; ++var14) {
						this.field163[var14] = var18[var10[var14] & 255];
					}
					...
					for (var15 = 0; var15 < var3; ++var15) {
						for (var16 = 0; var16 < var3; ++var16) {
							this.field163[var14++] = var18[var10[(var16 >> 1) + (var15 >> 1 << 6)] & 255];
						}
					}
				} else {
					...
					for (var15 = 0; var15 < var3; ++var15) {
						for (var16 = 0; var16 < var3; ++var16) {
							this.field163[var14++] = var18[var10[(var16 << 1) + (var15 << 1 << 7)] & 255];
						}
					}
				}
			}
