   ...
   static int method526(int var0, class461 var1, boolean var2) {
      ...
      if (var0 == 4000) {
         ...
         if (var0 == 4006) {
            ...
            long var11 = (long)class386.field3248[1 + class161.field1227];
            long var12 = (long)class386.field3248[class161.field1227 + 2];
            class386.field3248[++class161.field1227 - 1] = (int)(var10 * var12 / var11);
            return 1;
         } else if (var0 == 4025) {
