...
public class class491 extends class437 {
	...
	public class491() {
		this.field4089 = 256;
		this.field4097 = 1000000;
		this.field4086 = new int[16];
		this.field4090 = new int[16];
		this.field4094 = new int[16];
		this.field4088 = new int[16];
		this.field4108 = new int[16];
		this.field4100 = new int[16];
		this.field4091 = new int[16];
		this.field4092 = new int[16];
		this.field4093 = new int[16];
		this.field4083 = new int[16];
		this.field4095 = new int[16];
		this.field4096 = new int[16];
		this.field4085 = new int[16];
		this.field4098 = new int[16];
		this.field4099 = new int[16];
		this.field4084 = new class458[16][128];
		this.field4101 = new class458[16][128];
		this.field4102 = new class441();
		this.field4103 = new class101(this);
		this.field4087 = new class170(128);
		this.method2431();
	}
	...
	void method2410(int var1, int var2, int var3) {
		...
		class401 var10 = (class401)this.field4087.method791((long)this.field4108[var1]);
		if (null != var10) {
			class82 var9 = var10.field3377[var2];
			if (null != var9) {
				class458 var7 = new class458();
				var7.field3797 = var1;
				var7.field3787 = var10;
				var7.field3796 = var9;
				var7.field3798 = var10.field3379[var2];
				var7.field3788 = var10.field3382[var2];
				var7.field3789 = var2;
				var7.field3793 = 1024 + var10.field3381[var2] * var3 * var3 * var10.field3380 >> 11;
				var7.field3791 = var10.field3384[var2] & 255;
				var7.field3792 = (var2 << 8) - (var10.field3378[var2] & 32767);
				var7.field3795 = 0;
				var7.field3790 = 0;
				var7.field3786 = 0;
				var7.field3785 = -1;
				...
				if (this.field4085[var1] == 0) {
					var7.field3802 = class316.method1560(var9, this.method2416(var7), this.method2417(var7), this.method2418(var7));
				} else {
					var7.field3802 = class316.method1560(var9, this.method2416(var7), 0, this.method2418(var7));
					this.method2425(var7, var10.field3378[var2] < 0);
				}

				if (var10.field3378[var2] < 0) {
