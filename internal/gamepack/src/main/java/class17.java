   ...
   public final void method82(class127 var1, int var2) {
      ...
      if (var4 > 0L && var4 < 6582952005840035281L) {
         if (var4 % 37L == 0L) {
            ...
            while(var7 != 0L) {
               long var13 = var7;
               var7 /= 37L;
               var12.append(class417.field3429[(int)(var13 - var7 * 37L)]);
            }
      ...
      if (var15 != var9) {
         ...
         for(int var16 = 0; var16 < var11; ++var16) {
            class469 var17 = (class469)this.method1473(new class257(var1.method555(), this.field83));
            int var14 = var1.method549();
            var17.method303(var14, ++this.field88 - 1);
            var17.field628 = var1.method548();
            var1.method555();
            this.method81(var17);
         }
