...
public class class268 {
	...
	static byte[] field2217;
	@ObfInfo(
		owner = "ci",
		name = "n",
		desc = "Lqy;"
	)
	static class127 field2228;
	@ObfInfo(
		owner = "ci",
		name = "m",
		desc = "[Lqy;"
	)
	static class127[] field2218;
	@ObfInfo(
		owner = "ci",
		name = "x",
		desc = "[Lgs;"
	)
	static class294[] field2225;
	@ObfInfo(
		owner = "ci",
		name = "r",
		desc = "I"
	...
	static {
		field2217 = new byte[2048];
		field2225 = new class294[2048];
		field2218 = new class127[2048];
		field2221 = 0;
		field2220 = new int[2048];
		field2216 = 0;
		field2222 = new int[2048];
		field2219 = new int[2048];
		field2224 = new int[2048];
		field2226 = new int[2048];
		field2223 = 0;
		field2227 = new int[2048];
		field2228 = new class127(new byte[5000]);
	}
