...
public class class202 extends class392 {
	...
	static void method887(class274 var0, class274 var1, boolean var2, int var3) {
		if (class359.field3066) {
			...
			class344[] var12 = class400.method1972(var1, var9, var10);
			class342.field2746 = var12;
			...
			if (!class50.field574.method2213()) {
				class38 var13 = class317.field2494;
				var10 = var13.method1356("scape main");
				int var11 = var13.method1359(var10, "");
				class40.field201 = 1;
				class253.field2089 = var13;
			...
			if (null != class462.field3844) {
				try {
					class127 var17 = new class127(4);
					var17.method544(3);
					var17.method602(0);
					class462.field3844.method731(var17.field1072, 0, 4);
