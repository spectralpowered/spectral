		...
		if (var0 == ScriptOpcodes.CC_CREATE) {
			...
			if (var5 == 0) {
				...
				if (var7.field1031 == null) {
					var7.field1031 = new class120[var6 + 1];
				}

				if (var7.field1031.length <= var6) {
					class120[] var8 = new class120[var6 + 1];
				...
				if (var6 > 0 && null == var7.field1031[var6 - 1]) {
			...
			if (var0 == ScriptOpcodes.CC_DELETE) {
				...
				class120 var12 = class483.method2375(var4, var5);
				if (var12 != null && var5 != -1) {
					class386.field3248[++class161.field1227 - 1] = 1;
					if (var2) {
						class108.field822 = var12;
					} else {
						class37.field183 = var12;
					}
				} else {
					class386.field3248[++class161.field1227 - 1] = 0;
				}
