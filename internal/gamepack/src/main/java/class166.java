         ...
         for(var12 = -5; var12 < 109; ++var12) {
            for(var13 = 0; var13 < 104; ++var13) {
               ...
               if (var14 >= 0 && var14 < 104) {
                  ...
                  if (var16 > 0) {
                     class313 var52 = class32.method140(var16 - 1);
                     class71.field641[var13] += var52.field2468;
                     class233.field1986[var13] += var52.field2469;
                     class71.field648[var13] += var52.field2471;
                     class267.field2214[var13] += var52.field2474;
                     ++class365.field3099[var13];
                  }
               }
               ...
               if (var15 >= 0 && var15 < 104) {
                  ...
                  if (var17 > 0) {
                     class313 var54 = class32.method140(var17 - 1);
                     class71.field641[var13] -= var54.field2468;
                     class233.field1986[var13] -= var54.field2469;
                     class71.field648[var13] -= var54.field2471;
                     class267.field2214[var13] -= var54.field2474;
                     --class365.field3099[var13];
                  }
               }
            }
                  ...
                  if (var18 >= 1 && var18 < 103 && (!client.field274 || 0 != (class71.field644[0][var12][var18] & 2) || 0 == (class71.field644[var3][var12][var18] & 16))) {
                     ...
                     if (var22 > 0 || var23 > 0) {
                        ...
                        if (var3 > 0) {
                           ...
                           if (var23 > 0) {
                              ...
                              if (null != var37) {
                                 ...
                                 byte[] var38 = class179.field1646.method1365(4, var36);
                                 var37 = new class179();
                                 if (var38 != null) {
                                    var37.method815(new class127(var38), var36);
                                 }
                           ...
                           if (var55 && var25 == var24 && var24 == var26 && var27 == var24) {
                              class210.field1819[var3][var12][var18] |= 2340;
                           }
                        }
                        ...
                        if (var23 == 0) {
                           ...
                           byte var57 = class471.field3958[var3][var12][var18];
                           int var58 = var23 - 1;
                           class179 var39 = (class179)class179.field1647.method394((long)var58);
                           if (null != var39) {
                              var37 = var39;
                           } else {
                              byte[] var40 = class179.field1646.method1365(4, var58);
                              var39 = new class179();
                              if (null != var40) {
                                 var39.method815(new class127(var40), var58);
                              }

                              var39.method814();
                              class179.field1647.method396(var39, (long)var58);
                              var37 = var39;
                           }

                           int var59 = var37.field1649;
                           int var41;
                           int var42;
                           int var43;
                           int var44;
                           if (var59 >= 0) {
                              var42 = class341.field2728.method1496(var59);
                              var41 = -1;
                           ...
                           var0.method1564(var3, var12, var18, var35, var57, var59, var24, var25, var26, var27, class475.method2354(var32, var28), class475.method2354(var32, var29), class475.method2354(var32, var30), class475.method2354(var32, var31), class212.method917(var41, var28), class212.method917(var41, var29), class212.method917(var41, var30), class212.method917(var41, var31), var34, var43);
                        }
                     }
                  }
               }
         ...
         for(int var49 = 0; var49 <= var6; ++var49) {
            for(int var50 = 0; var50 <= 104; ++var50) {
               for(int var51 = 0; var51 <= 104; ++var51) {
                  short var53;
                  if (0 != (class210.field1819[var49][var51][var50] & var3)) {
                     var10 = var50;
                     var11 = var50;
                     var12 = var49;

                     for(var13 = var49; var10 > 0 && 0 != (class210.field1819[var49][var51][var10 - 1] & var3); --var10) {
                        ;
                     }

                     while(var11 < 104 && (class210.field1819[var49][var51][var11 + 1] & var3) != 0) {
                        ++var11;
                     }
                     ...
                     while(var12 > 0) {
                        for(var14 = var10; var14 <= var11; ++var14) {
                           if (0 == (class210.field1819[var12 - 1][var51][var14] & var3)) {
                              break label364;
                           }
                        }
                     ...
                     while(var13 < var6) {
                        for(var14 = var10; var14 <= var11; ++var14) {
                           if ((class210.field1819[var13 + 1][var51][var14] & var3) == 0) {
                              break label353;
                           }
                        }
                     ...
                     if (var14 >= 8) {
                        var53 = 240;
                        var16 = class71.field636[var13][var51][var10] - var53;
                        var17 = class71.field636[var12][var51][var10];
                        class318.method1609(var6, 1, var51 * 128, var51 * 128, var10 * 128, var11 * 128 + 128, var16, var17);

                        for(var18 = var12; var18 <= var13; ++var18) {
                           for(var19 = var10; var19 <= var11; ++var19) {
                              class210.field1819[var18][var51][var19] &= ~var3;
                           }
                        }
                     }
                  }

                  if (0 != (class210.field1819[var49][var51][var50] & var4)) {
                     var10 = var51;
                     var11 = var51;
                     var12 = var49;

                     for(var13 = var49; var10 > 0 && (class210.field1819[var49][var10 - 1][var50] & var4) != 0; --var10) {
                        ;
                     }

                     while(var11 < 104 && 0 != (class210.field1819[var49][var11 + 1][var50] & var4)) {
                        ++var11;
                     }
                     ...
                     while(var12 > 0) {
                        for(var14 = var10; var14 <= var11; ++var14) {
                           if ((class210.field1819[var12 - 1][var14][var50] & var4) == 0) {
                              break label417;
                           }
                        }
                     ...
                     while(var13 < var6) {
                        for(var14 = var10; var14 <= var11; ++var14) {
                           if ((class210.field1819[var13 + 1][var14][var50] & var4) == 0) {
                              break label406;
                           }
                        }
                     ...
                     if (var14 >= 8) {
                        var53 = 240;
                        var16 = class71.field636[var13][var10][var50] - var53;
                        var17 = class71.field636[var12][var10][var50];
                        class318.method1609(var6, 2, var10 * 128, 128 + var11 * 128, var50 * 128, var50 * 128, var16, var17);

                        for(var18 = var12; var18 <= var13; ++var18) {
                           for(var19 = var10; var19 <= var11; ++var19) {
                              class210.field1819[var18][var19][var50] &= ~var4;
                           }
                        }
                     }
                  }

                  if (0 != (class210.field1819[var49][var51][var50] & var5)) {
                     var10 = var51;
                     var11 = var51;
                     var12 = var50;

                     for(var13 = var50; var12 > 0 && (class210.field1819[var49][var51][var12 - 1] & var5) != 0; --var12) {
                        ;
                     }

                     while(var13 < 104 && (class210.field1819[var49][var51][var13 + 1] & var5) != 0) {
                        ++var13;
                     }
                     ...
                     while(var10 > 0) {
                        for(var14 = var12; var14 <= var13; ++var14) {
                           if (0 == (class210.field1819[var49][var10 - 1][var14] & var5)) {
                              break label470;
                           }
                        }
                     ...
                     while(var11 < 104) {
                        for(var14 = var12; var14 <= var13; ++var14) {
                           if ((class210.field1819[var49][var11 + 1][var14] & var5) == 0) {
                              break label459;
                           }
                        }
                     ...
                     if ((var13 - var12 + 1) * (1 + (var11 - var10)) >= 4) {
                        var14 = class71.field636[var49][var10][var12];
                        ...
                        for(var15 = var10; var15 <= var11; ++var15) {
                           for(var16 = var12; var16 <= var13; ++var16) {
                              class210.field1819[var49][var15][var16] &= ~var5;
                           }
                        }
                     }
                  }
