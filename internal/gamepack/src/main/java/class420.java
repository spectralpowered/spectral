   ...
   void method2019(byte[] var1) {
      ...
      if (var1.length == 257) {
         ...
         for(int var3 = 0; var3 < 256; ++var3) {
            this.field3450[var3] = var1[var2++] & 255;
         }
         ...
         for(var13 = 0; var13 < 256; ++var13) {
            if (var13 != 32 && var13 != 160) {
               for(var8 = 0; var8 < 256; ++var8) {
                  if (var8 != 32 && var8 != 160) {
                     this.field3444[(var13 << 8) + var8] = (byte)method2040(var11, var12, var4, this.field3450, var10, var13, var8);
                  }
               }
            }
         }

         this.field3442 = var4[32] + var10[32];
      }
            ...
            if (var15 == '<') {
               ...
               if (var15 == '>' && var10 != -1) {
                  ...
                  if (var16.equals("br")) {
                     ...
                     if (this.field3444 != null && var11 != -1) {
                        var4 += this.field3444[(var11 << 8) + 60];
                     }
                     ...
                     var4 += this.method2020('>');
                     if (this.field3444 != null && var11 != -1) {
                        var4 += this.field3444[(var11 << 8) + 62];
                     }
               ...
               if (var10 == -1) {
                  if (var15 != 0) {
                     ...
                     if (this.field3444 != null && var11 != -1) {
                        var4 += this.field3444[(var11 << 8) + var15];
                     }
         ...
         if (var1.charAt(var6) != 0) {
            ...
            if (var7 == '<') {
                     ...
                     if (!var8.equals("gt")) {
                        if (var8.startsWith("img=")) {
                           try {
                              ...
                              class344 var13 = field3443[var9];
                              var13.method1745(var2, var3 + this.field3442 - var13.field2759);
                              var2 += var13.field2756;
                              var5 = -1;
               ...
               if (var4 == -1) {
                  ...
                  int var10 = this.field3450[var7];
                  if (field3445 != -1) {
                     method752(var2, var3 + (int)((double)this.field3442 * 0.7D), var10, field3445);
                  }

                  if (field3451 != -1) {
                     method752(var2, var3 + this.field3442 + 1, var10, field3451);
                  }
         ...
         if (var1.charAt(var9) != 0) {
            ...
            if (var10 == '<') {
                     ...
                     if (!var11.equals("gt")) {
                        if (var11.startsWith("img=")) {
                           try {
                              ...
                              class344 var18 = field3443[var14];
                              var18.method1745(var2 + var12, var3 + this.field3442 - var18.field2759 + var13);
                              var2 += var18.field2756;
                              var7 = -1;
               ...
               if (var6 == -1) {
                  ...
                  int var15 = this.field3450[var10];
                  if (field3445 != -1) {
                     method752(var2, var3 + (int)((double)this.field3442 * 0.7D), var15, field3445);
                  }

                  if (field3451 != -1) {
                     method752(var2, var3 + this.field3442, var15, field3451);
                  }
