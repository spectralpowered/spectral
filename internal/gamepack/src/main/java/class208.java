...
public final class class208 extends class295 {
   ...
   static final void method904(int var0, int var1, int var2, int var3) {
      ...
      for(var26 = 0; var26 < client.field474; ++var26) {
         int var40 = client.field320[var26];
         ...
         while(var31) {
            ...
            for(int var32 = 0; var32 < var26; ++var32) {
               if (var28 + 2 > client.field321[var32] - client.field322[var32] && var28 - var30 < client.field321[var32] + 2 && var40 - var29 < client.field507[var32] + client.field320[var32] && var29 + var40 > client.field320[var32] - client.field507[var32] && client.field321[var32] - client.field322[var32] < var28) {
         ...
         String var41 = client.field318[var26];
         if (client.field397 == 0) {
            ...
            if (0 == client.field325[var26]) {
               class114.field848.method2027(var41, client.field436 + var0, var1 + client.field257, var33, 0);
            }

            if (client.field325[var26] == 1) {
               class114.field848.method2021(var41, client.field436 + var0, client.field257 + var1, var33, 0, client.field329);
            }

            if (client.field325[var26] == 2) {
               class114.field848.method2047(var41, var0 + client.field436, var1 + client.field257, var33, 0, client.field329);
            }

            if (client.field325[var26] == 3) {
               class114.field848.method2044(var41, client.field436 + var0, var1 + client.field257, var33, 0, client.field329, 150 - client.field415[var26]);
            }

            if (client.field325[var26] == 4) {
               var34 = (150 - client.field415[var26]) * (class114.field848.method2045(var41) + 100) / 150;
               class162.method743(var0 + client.field436 - 50, var1, client.field436 + var0 + 50, var1 + var3);
               class114.field848.method2025(var41, 50 + client.field436 + var0 - var34, client.field257 + var1, var33, 0);
               class162.method742(var0, var1, var2 + var0, var1 + var3);
            }
            ...
            if (client.field325[var26] == 5) {
               ...
               class114.field848.method2027(var41, var0 + client.field436, var35 + client.field257 + var1, var33, 0);
               class162.method742(var0, var1, var2 + var0, var1 + var3);
            }
         } else {
            class114.field848.method2027(var41, client.field436 + var0, client.field257 + var1, 16776960, 0);
         }
      }
      ...
      if (client.field230) {
         byte var39 = 0;
         var22 = var39 + class462.field3830 + class462.field3832;
         if (var22 == 0) {
