...
public class class128 {
   ...
   static int method609(int var0, class461 var1, boolean var2) {
      ...
      int var10;
      if (var0 == 1300) {
         var10 = class386.field3248[--class161.field1227] - 1;
         if (var10 >= 0 && var10 <= 9) {
            var5.method484(var10, class386.field3249[--class386.field3250]);
            return 1;
         } else {
            --class386.field3250;
            return 1;
         ...
         if (var0 == 1301) {
            ...
            var5.field979 = class483.method2375(var10, var11);
            return 1;
         } else if (var0 == 1302) {
            ...
            if (var0 != 1350) {
               ...
               if (var0 == 1351) {
                  class161.field1227 -= 2;
                  var9 = 10;
                  var7 = new byte[]{(byte)class386.field3248[class161.field1227]};
                  byte[] var12 = new byte[]{(byte)class386.field3248[class161.field1227 + 1]};
                  class362.method1805(var5, var9, var7, var12);
                  return 1;
               } else if (var0 == 1352) {
                  ...
                  if (var10 >= 0 && var10 <= 9) {
                     class374.method1846(var5, var10, var11, var8);
                     return 1;
                  } else {
                  ...
                  class374.method1846(var5, var9, var11, var8);
                  return 1;
               } else if (var0 == 1354) {
                  --class161.field1227;
                  var10 = class386.field3248[class161.field1227] - 1;
                  if (var10 >= 0 && var10 <= 9) {
                     class183.method834(var5, var10);
                     return 1;
                  } else {
                     throw new RuntimeException();
                  }
               ...
               if (var4) {
                  ...
                  if (var8 > 0) {
                     ...
                     for(var8 -= 2; var8 >= 0; var8 -= 2) {
                        var6[var8 / 2] = (byte)class386.field3248[class161.field1227 + var8];
                        var7[var8 / 2] = (byte)class386.field3248[1 + class161.field1227 + var8];
                     }
                  }
               } else {
                  class161.field1227 -= 2;
                  var6 = new byte[]{(byte)class386.field3248[class161.field1227]};
                  var7 = new byte[]{(byte)class386.field3248[class161.field1227 + 1]};
               }

               var8 = class386.field3248[--class161.field1227] - 1;
               if (var8 >= 0 && var8 <= 9) {
                  class362.method1805(var5, var8, var6, var7);
                  return 1;
               } else {
                  throw new RuntimeException();
               }
