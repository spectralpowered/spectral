...
public class class101 extends class437 {
	...
	class101(class491 var1) {
		this.field797 = new class141();
		this.field799 = new class244();
		this.field798 = var1;
	}
	...
	static int method401(int var0, class461 var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.CC_GETINVOBJECT) {
			...
			return 1;
		} else if (var0 == ScriptOpcodes.CC_GETCRM_HASRESPONSE) {
			class386.field3248[++class161.field1227 - 1] = var4.method488() ? 1 : 0;
			return 1;
		} else if (var0 == ScriptOpcodes.CC_GETCRM_INT) {
			return class102.method412(var4);
		} else {
			return var0 == ScriptOpcodes.CC_GETCRM_STRING ? class397.method1958(var4) : 2;
		}
	}
}
