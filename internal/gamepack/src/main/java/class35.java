...
public class class35 extends class400 {
	...
	static final void method147(int var0, int var1, int var2, int var3, int var4, String var5, String var6, int var7, int var8) {
		...
		class120 var18;
		if (var2 == 58) {
			var18 = class483.method2375(var1, var0);
			if (null != var18) {
				if (null != var18.field1003) {
					class488 var16 = new class488();
					var16.field4067 = var18;
					var16.field4070 = var3;
					var16.field4073 = var6;
					var16.field4069 = var18.field1003;
					class396.method1949(var16);
				}
		...
		if (var2 == 28) {
			...
			client.field279.method2389(var10);
			var19 = class67.method299(var1);
			if (null != var19 && var19.field885 != null && var19.field885[0][0] == 5) {
				var12 = var19.field885[0][1];
		...
		if (var2 == 29) {
			...
			client.field279.method2389(var10);
			var19 = class67.method299(var1);
			if (null != var19 && null != var19.field885 && 5 == var19.field885[0][0]) {
				var12 = var19.field885[0][1];
				if (class291.field2373[var12] != var19.field1022[0]) {
					class291.field2373[var12] = var19.field1022[0];
					class238.method1033(var12);
				}
			}
		}
		...
		if (var2 == 38) {
			...
			if (var2 == 1005) {
				var18 = class67.method299(var1);
				if (var18 != null && var18.field931[var0] >= 100000) {
					class164.method765(27, "", var18.field931[var0] + " x " + class423.method2062(var4).field2147);
				} else {
			...
			if (var2 == 24) {
				...
				if (null != var18) {
					boolean var13 = true;
					if (var18.field993 > 0) {
						var13 = class267.method1274(var18);
					}

					if (var13) {
						var14 = class480.method2370(class356.field3016, client.field279.field4042);
						var14.field2403.method534(var1);
			...
			if (var2 == 25) {
				...
				if (null != var18) {
					class120.method512();
					class128.method608(var1, var0, class486.method2379(class203.method892(var18)), var4);
					client.field386 = 0;
					client.field391 = class193.method868(var18);
					if (client.field391 == null) {
						client.field391 = class177.field1325;
					}

					if (var18.field893) {
						client.field510 = var18.field894 + class238.method1032(16777215);
					} else {
						client.field510 = class238.method1032(65280) + var18.field1000 + class238.method1032(16777215);
					}
				}
				...
				if (var2 == 1003) {
					...
					var17 = client.field465[var3];
					if (var17 != null) {
						class423 var20 = var17.field2213;
						if (var20.field3493 != null) {
							var20 = var20.method2054();
						}

						if (null != var20) {
							var14 = class480.method2370(class356.field2986, client.field279.field4042);
							var14.field2403.method573(var20.field3461);
							client.field279.method2389(var14);
						}
					}
				}
