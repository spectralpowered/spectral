...
public final class class44 {
   ...
   static class44[] field539 = new class44[0];
   @ObfInfo(
      owner = "oj",
      name = "x",
      desc = "I"
   ...
   static int field543 = 100;
   @ObfInfo(
      owner = "oj",
      name = "m",
      desc = "[F"
   )
   public float[] field541 = new float[16];
   ...
   public void method219(class44 var1) {
      for(int var3 = 0; var3 < this.field541.length; ++var3) {
         this.field541[var3] += var1.field541[var3];
      }
