...
public abstract class class434 implements Runnable {
	...
	class434(int var1) {
		this.field3599 = new LinkedList();
		this.field3600 = new Thread(this);
			...
			if (var5 == 22) {
				if (!client.field274 || var9.field724 != 0 || var9.field717 == 1 || var9.field743) {
					if (-1 == var9.field728 && var9.field745 == null) {
						var35 = var9.method366(22, var4, var16, var18, var17, var19);
					} else {
						var35 = new class89(var3, 22, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
					}

					var6.method1565(var0, var1, var2, var17, (class295)var35, var20, var22);
				...
				if (var5 >= 12) {
					if (var9.field728 == -1 && var9.field745 == null) {
						var35 = var9.method366(var5, var4, var16, var18, var17, var19);
					} else {
						var35 = new class89(var3, var5, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
					}

					var6.method1569(var0, var1, var2, var17, 1, 1, (class295)var35, 0, var20, var22);
					if (var5 >= 12 && var5 <= 17 && var5 != 13 && var0 > 0) {
						var10000 = class210.field1819[var0][var1];
						var10000[var2] |= 2340;
					}
					...
					if (var9.field728 == -1 && var9.field745 == null) {
						var35 = var9.method366(0, var4, var16, var18, var17, var19);
					} else {
						var35 = new class89(var3, 0, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
					}

					var6.method1567(var0, var1, var2, var17, (class295)var35, (class295)null, class71.field642[var4], 0, var20, var22);
					if (var4 == 0) {
						if (var9.field749) {
						...
						if (var9.field741) {
							var10000 = class210.field1819[var0][var1 + 1];
							var10000[var2] |= 585;
						}
					} else if (var4 == 3) {
						if (var9.field749) {
					...
					if (-1 == var9.field728 && var9.field745 == null) {
						var35 = var9.method366(1, var4, var16, var18, var17, var19);
					} else {
						var35 = new class89(var3, 1, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
					}

					var6.method1567(var0, var1, var2, var17, (class295)var35, (class295)null, class71.field646[var4], 0, var20, var22);
					if (var9.field749) {
						if (var4 == 0) {
							class36.field182[var0][var1][var2 + 1] = 50;
						} else if (var4 == 1) {
					...
					if (var5 == 2) {
						...
						if (-1 == var9.field728 && null == var9.field745) {
							var30 = var9.method366(2, var4 + 4, var16, var18, var17, var19);
							var31 = var9.method366(2, var29, var16, var18, var17, var19);
						} else {
							var30 = new class89(var3, 2, var4 + 4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
							var31 = new class89(var3, 2, var29, var0, var1, var2, var9.field728, var9.field737, (class295)null);
						}

						var6.method1567(var0, var1, var2, var17, (class295)var30, (class295)var31, class71.field642[var4], class71.field642[var29], var20, var22);
						if (var9.field741) {
							if (var4 == 0) {
								var10000 = class210.field1819[var0][var1];
								var10000[var2] |= 585;
						...
						if (-1 == var9.field728 && null == var9.field745) {
							var35 = var9.method366(3, var4, var16, var18, var17, var19);
						} else {
							var35 = new class89(var3, 3, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
						}
						...
						if (var9.field728 == -1 && var9.field745 == null) {
							var35 = var9.method366(4, var4, var16, var18, var17, var19);
						} else {
							var35 = new class89(var3, 4, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
						}

						var6.method1568(var0, var1, var2, var17, (class295)var35, (class295)null, class71.field642[var4], 0, 0, 0, var20, var22);
					} else {
						long var32;
						Object var34;
						if (var5 == 5) {
							var29 = 16;
							var32 = var6.method1613(var0, var1, var2);
							if (var32 != 0L) {
								var29 = class85.method356(class174.method803(var32)).field729;
							}

							if (-1 == var9.field728 && var9.field745 == null) {
								var34 = var9.method366(4, var4, var16, var18, var17, var19);
							} else {
								var34 = new class89(var3, 4, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
							}

							var6.method1568(var0, var1, var2, var17, (class295)var34, (class295)null, class71.field642[var4], 0, var29 * class71.field645[var4], var29 * class71.field639[var4], var20, var22);
						} else if (var5 == 6) {
							var29 = 8;
							var32 = var6.method1613(var0, var1, var2);
							if (0L != var32) {
								var29 = class85.method356(class174.method803(var32)).field729 / 2;
							}

							if (-1 == var9.field728 && var9.field745 == null) {
								var34 = var9.method366(4, var4 + 4, var16, var18, var17, var19);
							} else {
								var34 = new class89(var3, 4, var4 + 4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
							}

							var6.method1568(var0, var1, var2, var17, (class295)var34, (class295)null, 256, var4, var29 * class71.field647[var4], var29 * class71.field635[var4], var20, var22);
						} else if (var5 == 7) {
							var24 = var4 + 2 & 3;
							if (var9.field728 == -1 && var9.field745 == null) {
								var35 = var9.method366(4, var24 + 4, var16, var18, var17, var19);
							} else {
								var35 = new class89(var3, 4, var24 + 4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
							}

							var6.method1568(var0, var1, var2, var17, (class295)var35, (class295)null, 256, var24, 0, 0, var20, var22);
						} else if (var5 == 8) {
							var29 = 8;
							var32 = var6.method1613(var0, var1, var2);
							if (0L != var32) {
							...
							var6.method1568(var0, var1, var2, var17, (class295)var34, (class295)var27, 256, var4, class71.field647[var4] * var29, var29 * class71.field635[var4], var20, var22);
						}
					}
				}
			} else {
				if (-1 == var9.field728 && null == var9.field745) {
					var35 = var9.method366(10, var4, var16, var18, var17, var19);
				} else {
					var35 = new class89(var3, 10, var4, var0, var1, var2, var9.field728, var9.field737, (class295)null);
				}

				if (null != var35 && var6.method1569(var0, var1, var2, var17, var10, var11, (class295)var35, var5 == 11 ? 256 : 0, var20, var22) && var9.field749) {
					var24 = 15;
					if (var35 instanceof class470) {
						var24 = ((class470)var35).method2301() / 4;
						if (var24 > 30) {
							var24 = 30;
						}
					}
