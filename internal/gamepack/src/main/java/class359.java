...
public class class359 {
	...
	public static void method1789(int var0, int var1) {
		...
		if (null != var4) {
			...
			byte[] var9 = class457.field3778.method1365(14, var0);
			var4 = new class457();
			if (null != var9) {
				var4.method2256(new class127(var9));
			}
		...
		var8 <<= var6;
		class291.field2373[var5] = class291.field2373[var5] & ~var8 | var1 << var6 & var8;
	}
	...
	public static class357 method1791(int var0) {
		...
		if (null != var2) {
			...
			boolean var6 = true;
			byte[] var7 = var4.method1348(var0 >> 16 & 65535, var0 & 65535);
			class357 var3;
			if (var7 == null) {
				var6 = false;
				var3 = null;
