...
public class class238 implements Runnable {
	...
	class238() {
		this.field2010 = true;
		this.field2009 = new Object();
		this.field2015 = 0;
		this.field2011 = new int[500];
		this.field2012 = new int[500];
		this.field2013 = new long[500];
	}
	...
	static int method1031(int var0, class461 var1, boolean var2) {
		...
		if (var0 == ScriptOpcodes.IF_GETINVOBJECT) {
			...
			return 1;
		} else if (var0 == ScriptOpcodes.IF_GETCRM_HASRESPONSE) {
			var4 = class67.method299(class386.field3248[--class161.field1227]);
			class386.field3248[++class161.field1227 - 1] = var4.method488() ? 1 : 0;
			return 1;
		} else if (var0 == ScriptOpcodes.IF_GETCRM_INT) {
			var4 = class67.method299(class386.field3248[--class161.field1227]);
			return class102.method412(var4);
		} else if (var0 == ScriptOpcodes.IF_GETCRM_STRING) {
			var4 = class67.method299(class386.field3248[--class161.field1227]);
