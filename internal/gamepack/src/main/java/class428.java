...
public class class428 {
	...
	static {
		field3539 = new float[2][8];
		field3536 = new int[2][8];
	}
	...
	class428() {
		this.field3540 = new int[2];
		this.field3542 = new int[2][2][4];
		this.field3537 = new int[2][2][4];
		this.field3538 = new int[2];
	}
		...
		if (this.field3540[var1] == 0) {
			...
			for (var4 = 1; var4 < this.field3540[var1]; ++var4) {
				...
				for (int var7 = var4 * 2 - 1; var7 >= 2; --var7) {
					var10000 = field3539[var1];
					var10000[var7] += field3539[var1][var7 - 1] * var5 + field3539[var1][var7 - 2] * var6;
				}

				var10000 = field3539[var1];
				var10000[1] += field3539[var1][0] * var5 + var6;
				var10000 = field3539[var1];
				var10000[0] += var5;
			}
			...
			if (var1 == 0) {
				for (var4 = 0; var4 < this.field3540[0] * 2; ++var4) {
					var10000 = field3539[0];
					var10000[var4] *= field3541;
				}
			}
