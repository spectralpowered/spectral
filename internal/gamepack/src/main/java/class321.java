...
public class class321 {
	...
	public class321() {
		this.field2554 = Integer.MAX_VALUE;
		this.field2555 = 0;
		this.field2556 = true;
		this.field2557 = true;
		this.field2559 = new ArrayList();
		this.field2560 = 0;
		this.field2561 = 0;
	}
		...
		if (!this.method1642() && null != this.field2558) {
			...
			for (int var7 = var1; var7 < var2; ++var7) {
				...
				if (var8.field544 == '\n') {
					...
					int var19 = this.method1639(var8, false);
					if (this.field2556 && var8.field546 + var19 > this.field2554) {
						boolean var20 = false;
						if (1 == this.field2560) {
							for (var11 = var7; var11 > 0; --var11) {
								class45 var18 = (class45)this.field2559.get(var11 - 1);
								if (var8.field545 != var18.field545) {
									break;
								}

								if (var18.field544 == ' ' || var18.field544 == '\t') {
