...
public class class433 implements KeyListener, FocusListener {
      ...
      for(int var12 = 0; var12 < 8; ++var12) {
         for(var13 = 0; var13 < 8; ++var13) {
            if (var2 + var12 > 0 && var2 + var12 < 103 && var3 + var13 > 0 && var3 + var13 < 103) {
               var10[var1].field3534[var2 + var12][var3 + var13] &= -16777217;
            }
         }
      }
   ...
   static int method2145(int var0, class461 var1, boolean var2) {
      if (var0 == 6754) {
         ...
         class423 var7 = class421.method2049(var6, (byte)115);
         class386.field3249[++class386.field3250 - 1] = null != var7 ? var7.field3460 : "";
         return 1;
      } else if (var0 == 6764) {
         class161.field1227 -= 2;
         class423 var4 = class421.method2049(class161.field1227, (byte)29);
         int var5 = class386.field3248[1 + class161.field1227];
         class386.field3248[++class161.field1227 - 1] = var4.method2052(var5);
         class386.field3248[++class161.field1227 - 1] = var4.method2059(var5);
         return 1;
      } else {
         return 2;
      }
