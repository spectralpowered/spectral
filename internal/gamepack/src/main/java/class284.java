...
public class class284 {
	...
	static {
		field2353 = new int[]{8, 11, 4, 6, 9, 7, 10};
		field2354 = new class99(260);
	}
		...
		if (this.field2344 != -1) {
			...
			if (var19 == null) {
				...
				if (var19 == null) {
					...
					class26 var21 = new class26(var20, var12);

					for (var14 = 0; var14 < 5; ++var14) {
						if (this.field2345[var14] < class90.field769[var14].length) {
							var21.method113(class112.field840[var14], class90.field769[var14][this.field2345[var14]]);
						}

						if (this.field2345[var14] < class291.field2374[var14].length) {
							var21.method113(class207.field1786[var14], class291.field2374[var14][this.field2345[var14]]);
						}
					}

					var19 = var21.method121(64, 850, -30, -50, -30);
			...
			if (var1 == null && null == var3) {
				var22 = var19.method2298(true);
			} else if (null != var1 && null != var3) {
				var22 = var1.method1062(var19, var2, var3, var4);
			} else if (var1 != null) {
				var22 = var1.method1053(var19, var2);
			} else {
				var22 = var3.method1053(var19, var4);
			}
