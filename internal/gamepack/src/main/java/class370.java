...
public class class370 extends class139 {
	...
	float[] method1833(int var1) {
		...
		for (var17 = 0; var17 < var14.field1064; ++var17) {
			...
			var18.method1368(var19, var4 >> 1, var45);
		}

		int var40;
		if (!var15) {
			var17 = var14.field1063;
			var40 = var14.field1065[var17];
			field3142[var40].method287(field3152, var4 >> 1);
		}
		...
		if (var15) {
			...
			float[] var44 = var3 ? field3156 : field3153;
		...
		float[] var41 = null;
		if (this.field3163 > 0) {
			var40 = this.field3163 + var4 >> 2;
			var41 = new float[var40];
			int var20;
			if (!this.field3151) {
				for (var42 = 0; var42 < this.field3150; ++var42) {
					var20 = (this.field3163 >> 1) + var42;
					var41[var42] += this.field3148[var20];
				}
			}
			...
			if (!var15) {
				for (var42 = var8; var42 < var4 >> 1; ++var42) {
					...
					var41[var20] += field3152[var42];
				}
			}
		}

		float[] var46 = this.field3148;
	...
	static void method1828(byte[] var0) {
		...
		for (var1 = 0; var1 < 2; ++var1) {
			...
			for (int var11 = 0; var11 < var5; ++var11) {
				var14[var11] = class486.method2385(var11, var10);
			}
		...
		for (int var15 = 0; var15 < var5; ++var15) {
			field3145[var15] = method1832() != 0;
			method1826(16);
			method1826(16);
			field3131[var15] = method1826(8);
		}
