...
public class InjectionClassLoader extends URLClassLoader {
    ...
    public InjectionClassLoader(final InjectionManager injectionManager, final URL... urls) {
        this(injectionManager, InjectionClassLoader.class.getClassLoader(), urls);
    }

    public InjectionClassLoader(final InjectionManager injectionManager, final ClassLoader parent, final URL... urls) {
        super(urls, null);
    ...
    protected Class<?> findClass(final String name) throws ClassNotFoundException {
        ...
        try {
            ...
            byte[] transformedClassBytes = this.injectionManager.transform(name, classBytes);
