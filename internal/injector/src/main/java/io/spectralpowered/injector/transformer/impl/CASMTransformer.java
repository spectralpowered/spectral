...
public class CASMTransformer extends ARemovingTransformer<CASM> {
    ...
    @Override
    public void transform(CASM annotation, InjectionManager injectionManager, IClassProvider classProvider, Map<String, IInjectionTarget> injectionTargets, ClassNode transformedClass, ClassNode transformer, MethodNode transformerMethod) {
