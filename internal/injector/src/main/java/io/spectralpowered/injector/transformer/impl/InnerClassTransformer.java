...
public class InnerClassTransformer extends ATransformer {
    ...
    @Override
    public void transform(InjectionManager injectionManager, IClassProvider classProvider, Map<String, IInjectionTarget> injectionTargets, ClassNode injectedClass, ClassNode transformer) {
        ...
        for (InnerClassNode innerClass : transformer.innerClasses) {
            ...
            injectionManager.addRawTransformer(dot(innerClass.name), (tm, transformedClass) -> {
